...
namespace MeatLantern
{
    public static class MeatLanternUtility
    {
        ...
        public static void OnMeatLanternDeath(Pawn pawn, Map map)
        {
            ...
            ((DyingMeatLantern)GenSpawn.Spawn(ThingDefOf.DyingMeatLantern, pawn.Position, map)).InitWith(pawn);
        }
        ...
        {
            ((EscapingMeatLantern)GenSpawn.Spawn(ThingDefOf.EscapingMeatLantern, pawn.Position, map)).InitWith(pawn);
        }
    }
}
